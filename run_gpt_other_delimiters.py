# Used to create:
# 20230518_gpt_other_delimiters.csv
...
# formats = ['dec_r2l', 'dec_l2r', 'hashtag_r2l', 'hashtag_l2r', 'dollar_r2l', 'dollar_l2r', 'foo_r2l', 'foo_l2r']
formats = ['foo_r2l']
num_shots = [1, 2, 4, 8]
system_prompts = ['You are a helpful assistant.']
repeat_styles = [None]
exp_name = 'gpt_other_delimiters_foo_r2l'
