# Used to create:
# 20230524_gpt_comma_effects_repeat_style_triplets.csv
...
system_prompts = [
	...
	'You are MathGPT, an expert at solving math problems. You do not say any other words.',
...
exp_name = 'gpt_comma_effects_repeat_style_triplets'
